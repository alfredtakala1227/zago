angular.module('app').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('pieces/grid.html',
    "<div class=gridBox><div ng-repeat=\"section in sections\"><div class=gridWrapper ng-class=\"{ gridLeft: $index % 6; }\"><div ng-class=\"{ grid: $index % 3; gridLeft: $index % 6; }\"><div ng-if=\"gridType == 'project-section'\"><project-section></project-section></div><div ng-if=\"gridType == 'team-section'\"><team-section></team-section></div></div></div></div></div>"
  );
  ...
  $templateCache.put('partials/projects.html',
    "<div class=blurb><h1 under-z str={{blurb.title}}></h1><div ng-bind-html=blurb.body></div></div><new-grid></new-grid>"
  );
